namespace BtC
{
    partial class BtC
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(BtC));
            EIGHT = new ePOSOne.btnProduct.Button_WOC();
            SEVEN = new ePOSOne.btnProduct.Button_WOC();
            SIX = new ePOSOne.btnProduct.Button_WOC();
            FIVE = new ePOSOne.btnProduct.Button_WOC();
            FOUR = new ePOSOne.btnProduct.Button_WOC();
            THREE = new ePOSOne.btnProduct.Button_WOC();
            TWO = new ePOSOne.btnProduct.Button_WOC();
            ONE = new ePOSOne.btnProduct.Button_WOC();
            SPDropdown = new ComboBox();
            COMconnect = new ProgressBar();
            MainPanel = new Panel();
            button1 = new Button();
            ...
            EIGHT.Enabled = false;
            EIGHT.FlatAppearance.MouseDownBackColor = Color.Transparent;
            ...
            SEVEN.Enabled = false;
            SEVEN.FlatAppearance.MouseDownBackColor = Color.Transparent;
            ...
            SIX.Enabled = false;
            SIX.FlatAppearance.MouseDownBackColor = Color.Transparent;
            ...
            FIVE.Enabled = false;
            FIVE.FlatAppearance.MouseDownBackColor = Color.Transparent;
            ...
            FOUR.Enabled = false;
            FOUR.FlatAppearance.MouseDownBackColor = Color.Transparent;
            ...
            THREE.Enabled = false;
            THREE.FlatAppearance.MouseDownBackColor = Color.Transparent;
            ...
            TWO.Enabled = false;
            TWO.FlatAppearance.MouseDownBackColor = Color.Transparent;
            ...
            ONE.Enabled = false;
            ONE.FlatAppearance.MouseDownBackColor = Color.Transparent;
            ...
            // SPDropdown
            // 
            SPDropdown.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
            SPDropdown.BackColor = Color.Black;
            SPDropdown.DropDownStyle = ComboBoxStyle.DropDownList;
            SPDropdown.DropDownWidth = 100;
            SPDropdown.FlatStyle = FlatStyle.Popup;
            SPDropdown.Font = new Font("White Rabbit", 23.9999981F, FontStyle.Bold, GraphicsUnit.Point);
            SPDropdown.ForeColor = Color.White;
            ...
            MainPanel.Controls.Add(SPDropdown);
        ...
        private ePOSOne.btnProduct.Button_WOC EIGHT;
        private ePOSOne.btnProduct.Button_WOC SEVEN;
        private ePOSOne.btnProduct.Button_WOC SIX;
        private ePOSOne.btnProduct.Button_WOC FIVE;
        private ePOSOne.btnProduct.Button_WOC FOUR;
        private ePOSOne.btnProduct.Button_WOC THREE;
        private ePOSOne.btnProduct.Button_WOC TWO;
        private ePOSOne.btnProduct.Button_WOC ONE;
        private ComboBox SPDropdown;
        private ProgressBar COMconnect;
